...
RSpec.describe ProjectsController, type: :controller do
  ...
  describe 'POST #create' do
    ...
    context 'success save' do
      before { post :create, title: project.title }
  ...
  describe 'POST #update' do
    ...
    context 'success update' do
      before { patch :update, id: project.id, title: 'new name' }

      context 'cancan doesnt allow :update' do
        before do
          ability.cannot :update, Project
          patch :update, id: project.id, title: 'new name'
        end
        it { expect(response).to redirect_to(root_path) }
      end
      ...
      it '#update project' do
        ...
        patch :update, id: project.id, title: project.title
      end
    end

    context 'invalid update' do
      before do
        patch :update, id: project.id, title: nil
      end
